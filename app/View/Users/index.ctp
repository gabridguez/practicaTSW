...
<table>
    <thead>
        <tr>
            ...
            <th><?php echo $this->Paginator->sort('name', 'E-Mail');?></th>
    ...
    <tbody>                       
        ...
        <?php endif; ?>
            ...
            <td style="text-align: center;"><?php echo $user['User']['foto']; ?></td>
            <td >
...
<?php echo $this->Html->link( " Sign up ",   array('action'=>'add'),array('escape' => false) ); ?>
<br/>
<?php 
